...
PASS  S2: single plugin discovered  [[{"id":"pkg-solo","name":"pkg-solo","layers":["file:C:\\Users\\SolimPurmiss\\Desktop\\DeepForge\\dsh-forge\\.tmp-tests\\x-single-KDFidj\\c.yml"]}]]
...
PASS  S4: disabled parsed  [{"id":"pkg-off","name":"pkg-off","disabled":true,"layers":["file:C:\\Users\\SolimPurmiss\\Desktop\\DeepForge\\dsh-forge\\.tmp-tests\\x-disable-TWCoJk\\c.yml"]}]
PASS  S4: config parsed  [{"id":"pkg-cfg","name":"pkg-cfg","configPresent":true,"configText":"\n    profile: web\n","layers":["file:C:\\Users\\SolimPurmiss\\Desktop\\DeepForge\\dsh-forge\\.tmp-tests\\x-disable-TWCoJk\\c.yml"]}]
PASS  S4: disabled-row finding  [["disabled-row"]]
PASS  S5: row merged across layers  [["file:C:\\Users\\SolimPurmiss\\Desktop\\DeepForge\\dsh-forge\\.tmp-tests\\x-override-kVAiGT\\a.yml","file:C:\\Users\\SolimPurmiss\\Desktop\\DeepForge\\dsh-forge\\.tmp-tests\\x-override-kVAiGT\\b.yml"]]
